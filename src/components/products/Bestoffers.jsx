  ...
  return (
    <div className="py-12 bg-gray-50 relative">
      <div className='flex justify-between items-center w-[98%] md:w-11/12 mx-auto mb-8'>
        <h2 className="text-2xl lg:text-3xl font-medium text-mainclr">Best Offers</h2>
      ...
      >
        {bestOffers?.slice(0, 10).map((product) => (
      ...
      <div className="best-offers-pagination flex justify-center space-x-2 "></div>
    </div>
  );
};
