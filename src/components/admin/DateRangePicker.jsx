      ...
      {showDatePicker && (
        <div className="bg-white px-3 py-2 rounded-lg shadow-2xl absolute right-0 top-10 text-sm ">
          ...
          <div className="flex gap-2">
            <button
              className="bg-mainclr px-3 lg:px-12 py-3 rounded-lg hover:bg-mainhvr text-white w-full"
              onClick={() => {
                toggleDatePicker();
            ...
            <button
              className="border-2 text-red-500 hover:text-red-200 uppercase text-sm border-red-500 px-5 font-semibold lg:px-12 py-3 rounded-lg hover:bg-red-500 w-full"
              onClick={() => {
                setStartingDate("");
                setEndingDate("");
                toggleDatePicker();
