...
const CustomFileInput = ({ onChange }) => {
    ...
    return (
        <div
            className={`border-dashed border-2 p-8 rounded-lg text-center ${isDragging
                    ? "bg-blue-100 border-mainclr"
        ...
        >
            ...
            <button
                className="bg-zinc-200 text-mainclr text-sm font-semibold py-2 px-4 rounded"
